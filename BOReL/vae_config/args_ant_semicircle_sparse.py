...
def get_args(rest_args):
    ...
    parser.add_argument("--dense-train-sparse-test", default=True)
    ...
    # parser.add_argument('--data-dir', default='data_no_modify_init_state_dist')   # without modified Pinit
    parser.add_argument(
        "--data-dir", default="data_semi_modified_init_state_dist"
    )  # semi-modified Pinit - not on circle

    # # # save dir prefix -- with and without relabeling
    # parser.add_argument('--save-dir-prefix', default='relabel')
    # parser.add_argument('--save-dir-prefix', default='relabel_no_modify_init_state_dist')
    parser.add_argument(
        "--save-dir-prefix", default="relabel_semi_modified_init_state_dist"
    )
    # parser.add_argument('--save-dir-prefix', default='no_relabel')
    # parser.add_argument('--save-dir-prefix', default='no_relabel_no_modify_init_state_dist')
    # parser.add_argument('--save-dir-prefix', default='no_relabel_semi_modified_init_state_dist')
