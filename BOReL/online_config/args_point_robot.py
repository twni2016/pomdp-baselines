...
def get_args(rest_args):
    ...
    # --- ENV ---
    parser.add_argument(
        "--env-name", default="PointRobot-v0", help="environment to train on"
    )
    ...
    parser.add_argument(
        "--num-tasks", type=int, default=25, help="number of goals in environment"
    )
    parser.add_argument(
        "--num-train-tasks", type=int, default=20, help="number of tasks for train"
    )
    parser.add_argument(
