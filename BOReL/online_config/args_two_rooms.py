...
def get_args(rest_args):
    ...
    # --- ENV ---
    parser.add_argument(
        "--env-name", default="TwoRooms-v2", help="environment to train on"
    )
    ...
    parser.add_argument(
        "--num-tasks", type=int, default=5, help="number of goals in environment"
    )
    parser.add_argument(
        "--num-train-tasks", type=int, default=3, help="number of tasks for train"
    )
    parser.add_argument(
        "--num-eval-tasks", type=int, default=2, help="number of tasks for evaluation"
    )
    ...
    # general
    parser.add_argument(
        "--train-vae", type=boolean_argument, default=True, help="whether to update vae"
    )
    parser.add_argument(
        "--vae-lr",
        type=float,
