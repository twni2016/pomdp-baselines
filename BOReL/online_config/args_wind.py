...
def get_args(rest_args):
    ...
    parser.add_argument(
        "--vae-buffer-size", type=int, default=5e4, help="buffer size for VAE updates"
    )
    # --- ENV ---
    parser.add_argument("--env-name", default="Wind-v0", help="environment to train on")
    parser.add_argument("--max-rollouts-per-task", type=int, default=1)
    parser.add_argument(
        "--is-sparse-env",
        type=boolean_argument,
        default=False,
        help="rewards are 0. or -0.1",
    )
    parser.add_argument(
        "--num-tasks", type=int, default=60, help="number of goals in environment"
    )
    parser.add_argument(
        "--num-train-tasks", type=int, default=40, help="number of tasks for train"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.00007,
        help="learning rate for actor (default: 7e-5)",
    )
    parser.add_argument(
        "--critic-lr",
        type=float,
        default=0.00007,
        help="learning rate for critic (default: 7e-5)",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--kl-weight", type=float, default=0.1, help="weight for the KL term"
    )
    ...
    parser.add_argument("--reward-embedding-size", type=int, default=0)
    ...
    parser.add_argument(
        "--decode-state", type=boolean_argument, default=True, help="use state decoder"
    )
