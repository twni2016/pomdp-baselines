...
class RolloutStorage(object):
    ...
    def recurrent_generator(self, advantages, num_mini_batch):
        ...
        num_envs_per_batch = num_processes // num_mini_batch  # 32/1 =32
        perm = torch.randperm(num_processes)
        for start_ind in range(0, num_processes, num_envs_per_batch):  # once
            obs_batch = []
            ...
            for offset in range(num_envs_per_batch):  # 32
            ...
            T, N = self.num_steps, num_envs_per_batch  # T, 32
